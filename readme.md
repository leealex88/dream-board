...
This is my second project during the General Assembly Software Engineering Immersive course (Week 6). The project was made in collaboration with Mia Meroi (https://github.com/MiaLearnsToCode) as part of a two-day long "Reactathon".
